...
class IAClient():
    def __init__(self, api_key: Optional[str] = '', hf_model='meta-llama/Llama-3.1-8B-Instruct:cerebras', max_tokens: Optional[int] = 1000) -> None:
        self.update_config(api_key=api_key, hf_model=hf_model, max_tokens=max_tokens)

    def update_config(self, api_key: Optional[str] = '', openai_model: Optional[str] = '', hf_model: Optional[str] = '', max_tokens: Optional[int] = 1000) -> None:
